...
//             <button className={`flex items-center space-x-2 px-6 py-2.5 rounded-full font-medium transition-all duration-300 transform hover:scale-105 ${
//               isScrolled
...
//   <NavLink
//     to="/loginpage"
//     className={`flex items-center space-x-2 px-6 py-2.5 rounded-full font-medium transition-all duration-300 transform hover:scale-105 ${
//       isScrolled
//         ? "text-gray-700 hover:text-gray-900 hover:bg-gray-100"
//         : "text-white hover:text-gray-200 hover:bg-white/10 backdrop-blur-sm"
//     }`}
...
//   </NavLink>
// </div>
//           {/* <button className="flex items-center space-x-2 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white px-6 py-2.5 rounded-full font-medium shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:from-blue-700 hover:via-purple-700 hover:to-pink-700">
...
//               {/* Mobile Logo (if needed for branding) */}
...
//                 <button className="w-full flex items-center justify-center space-x-2 px-6 py-3 text-gray-700 font-medium rounded-xl border border-gray-300 hover:bg-gray-50 transition-colors">
//                   <LogIn className="w-4 h-4" />
//                   <span>Login</span>
//                 </button>
